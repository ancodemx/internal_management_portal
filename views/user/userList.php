                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="form-group col-12">
                            ...
                            data-toggle="modal" data-target="#modal_form_user"
                            data-bs-toggle="modal" data-bs-target="#modal_form_user"
                    ...
                    <div class="row">
                        <div class="col-lg-12 table-responsive">
                            <table id="gridUsers" class="table table-hover" role="grid" style="font-size: 14px; width: 100%; margin-top: 0px !important;">
                                <thead>
                                    <tr>
                ...
                const option = {
                    'success': (data) => {
                        ...
                        //if ( data.accion == 'editar' ){
                            ...
                            let iframeHijo = window.parent.document.getElementById('usuario');
                            ...
                            let match = url.match(/\/user\/(edit|create)/);
                            let baseUrl = '';
                            if (match) {
        ...
        const opciones = {
            ...
            'edit': (user_id) => {
                setTimeout(function() {
                    ...
                    UI.create_tab('Usuario', URL_PATH + 'user/edit');
                    let iframeDestino = window.parent.document.getElementById("usuario");
                    let url = URL_PATH + CONTROLADOR + '/edit/' + user_id;
