...
class UpdateProfileUseCase
{
    ...
    public function execute(array $userPostData ) : array
    {
        ...
        try {
            ...
            $temp_profile_data = Session::get('temp_profile_data')[0];

            // Si el profile_name no fue modificado dejarla pasar
            if ($temp_profile_data['profile_name'] != $profile_post_data['profile_name']) {
            ...
            $response  = $this->profileService->update($profile_post_data);
