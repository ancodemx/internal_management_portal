...
(function (global, factory) {
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.crearSLUG = function crearSLUG(slug) 
    {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      let id_frame = this.crearSLUG(title);
      id_frame = normalize(id_frame);

      var newNavItem = "<li class=\"nav-item\" role=\"presentation\"><a href=\"#\" class=\"btn-iframe-close\" data-widget=\"iframe-close\" data-type=\"only-this\"><i class=\"fas fa-times\"></i></a><a class=\"nav-link\" data-toggle=\"row\" id=\"" + navId + "\" href=\"#" + tabId + "\" role=\"tab\" aria-controls=\"" + tabId + "\" aria-selected=\"false\">" + title + "</a></li>";
      $__default["default"](SELECTOR_TAB_NAVBAR_NAV).append(unescape(escape(newNavItem)));
      var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><iframe src=\"" + link + "\" id=\""+id_frame+"\"></iframe></div>";
    ...
    /* IFrame._jQueryInterface = function _jQueryInterface(config) {
      ...
      if ($__default["default"](SELECTOR_DATA_TOGGLE$1).length > 0) {
        ...
        localStorage.setItem('AdminLTE:IFrame:Options', JSON.stringify(_options, getCircularReplacer()));
    ...
    IFrame._jQueryInterface = function _jQueryInterface(config, name, link, id, reload) {
      ...
      if ($__default["default"](SELECTOR_DATA_TOGGLE$1).length > 0) {
        ...
        $__default["default"](this).data(DATA_KEY$7, typeof config === 'object' ? config : { link, name, id, reload, ...data });
        //console.log(config);
        if (typeof config === 'string' && /createTab|openTabSidebar|switchTab|removeActiveTab/.test(config)) {
          plugin[config]();
          //console.log(plugin);
